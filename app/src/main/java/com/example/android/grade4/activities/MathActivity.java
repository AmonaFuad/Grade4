...
import com.example.android.grade4.rest.MathServer;
...
public class MathActivity extends YouTubeBaseActivity implements RecycleViewClickable {
    ...
    {
        final MathServer apiService =
                ApiClient.getClient().create(MathServer.class);
        ...
        call.enqueue(new Callback <BaseClass>() {
            ...
            public void onFailure(Call <BaseClass> call, Throwable t) {
                Toast.makeText(MathActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void onMyAdapterClick(int itemPosition) {
        Intent intent = new Intent(MathActivity.this, VideoPlayAcyivity.class);
