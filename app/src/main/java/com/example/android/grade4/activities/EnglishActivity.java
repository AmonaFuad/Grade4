...
import com.example.android.grade4.rest.ApiSirver;
...
public class EnglishActivity extends YouTubeBaseActivity implements RecycleViewClickable {
    ...
    public void onMyAdapterClick(int itemPosition) {
        Intent intent = new Intent(EnglishActivity.this, VideoPlayAcyivity.class);
