...
import com.example.android.grade4.rest.SocialServer;
...
public class SocialActivity extends YouTubeBaseActivity implements RecycleViewClickable {
    ...
    {
        final SocialServer apiService =
                ApiClient.getClient().create(SocialServer.class);
        ...
        call.enqueue(new Callback <BaseClass>() {
            ...
            public void onFailure(Call <BaseClass> call, Throwable t) {
                Toast.makeText(SocialActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void onMyAdapterClick(int itemPosition) {
        Intent intent = new Intent(SocialActivity.this, VideoPlayAcyivity.class);
